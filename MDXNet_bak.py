...
class Predictor:
    def __init__(self, args):
        ...
        print("self.model info:" + str(self.model.get_inputs()[0]))
    ...
    def demix(self, mix):
        ...
        for skip in range(0, samples, chunk_size):
            ...
            if end == samples:
                break
        print("segmented_mix: " + str(segmented_mix))
    ...
    def demix_base(self, mixes, margin_size):
        print("demix_base")
        print("cpu: " + str(cpu))
        print("self.model_: " + str(self.model_) + str(self.model_.__dict__))
        chunked_sources = []
    ...
    def prediction(self, m, vocal_root, others_root, format):
        ...
        mix = mix.T
        print("mix.shape: " + str(mix.shape))
        sources = self.demix(mix.T)
        opt = sources[0].T
        print("opt.shape: " + str(opt.shape))
