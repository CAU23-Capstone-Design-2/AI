...
if __name__ == "__main__":
    ...
    try:
        ...
        os.rename(
            f"./inst/instrument_{music_code}.wav_10.wav", f"./inst/{music_code}.wav"
        )
    ...
    try:
        ...
        print(result.stderr)
        os.rename(
            f"./inst/instrument_{music_code}.wav_10.wav", f"./dereverb/{music_code}.wav"
        )
