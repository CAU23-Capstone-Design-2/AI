...
class RVC:
    ...
    def get_f0_rmvpe(self, x, f0_up_key):
        if hasattr(self, "model_rmvpe") == False:
            ...
            # self.model_rmvpe = RMVPE("aug3_60000_half.pt", is_half=self.is_half, device=self.device)
            # self.model_rmvpe = RMVPE("aug3_120000_half.pt", is_half=self.is_half, device=self.device)
